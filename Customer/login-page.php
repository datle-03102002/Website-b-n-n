   ...
   <div class="login-container">
      ...
      <div class="form-login">
        <form action="signin.php" method="POST" class="form" id="form-2">
          <div class="text-center"><h3 class="heading">Đăng nhập</h3></div>   
          ...
          <div class="form-group">
            ...
            <select name="permission" id="permission" style="heigh:50px;">
          ...
          <div class="sign-up">
              <div>
                <button class="form-submit" id="signin" name="signin" value="true">Sign in</button>
                <i class="fas fa-chevron-right"></i>
              </div>
              <div class="space"></div>
              <div>
                <button class="form-submit"type="button"><a href="signup-page.php">Sign up</a></button>
                <i class="fas fa-chevron-right"></i>
              </div>
          </div>
        </form>
