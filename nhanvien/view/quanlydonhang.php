...
<div class="d-flex align-items-center justify-content-between">
  ...
  <tbody>
		<?php
			...
			$sql = "SELECT * FROM order_ INNER JOIN orderdetail ON order_.order_id = orderdetail.order_id";
			...
			while($row = mysqli_fetch_assoc($kq)){
				...
				<tr>
					...
					<td >
						<a href="index.php?a=capnhatdonhang&order_id=<?=$row['order_id']?>&state=<?=$row['state']?>">
							<button class="btn btn-primary" style="margin-right: 10px;">Cập nhật</button>
						</a>
					</td>
